...
public class AyudanteBaseDeDatos extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format("CREATE TABLE IF NOT EXISTS %s(id integer primary key autoincrement, nombre text, apodo text, pin int)", NOMBRE_TABLA_USUARIOS));
        ...
        db.execSQL(String.format("CREATE TABLE IF NOT EXISTS %s(id integer primary key autoincrement, categoria text)", NOMBRE_TABLA_CATEGORIAS));
