...
public class ParticipaTransaccionController {
    ...
    public ParticipaTransaccionController(Context contexto) {
        ayudanteBaseDeDatos = new AyudanteBaseDeDatos(contexto);
        usuarioAppController = new UsuarioAppController(contexto);
    }


    public int eliminarParticipante(Miembro participante) {
    ...
    public long nuevoParticipante(Miembro participante) {
    ...
    public int guardarCambios(Miembro participanteçEditado) {
        SQLiteDatabase baseDeDatos = ayudanteBaseDeDatos.getWritableDatabase();
        ContentValues valoresParaActualizar = new ContentValues();

        valoresParaActualizar.put("walletId", participanteçEditado.getWalletId());
        valoresParaActualizar.put("userId", participanteçEditado.getUserId());

        // where id...
        String campoParaActualizar = "id = ?";
        // ... = idMiembro
        String[] argumentosParaActualizar = {String.valueOf(participanteçEditado.getId())};
    ...
    public ArrayList<Miembro> obtenerParticipan(long transaccionId) {
        ...
        for (String usuarioIdDbParticipa : participaLista) {
            ...
            usuarioCompletoLista = usuarioAppController.obtenerUsuarioNombre(miembroLong);
